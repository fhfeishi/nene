...
class TTSServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Synthesize = channel.unary_unary(
                '/nene.voice.TTSService/Synthesize',
...
class TTSServiceServicer(object):
    ...
    def Synthesize(self, request, context):
        """定义一个名为 Synthesize 的方法：输入文本，输出音频
        """
...
def add_TTSServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'nene.voice.TTSService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('nene.voice.TTSService', rpc_method_handlers)
